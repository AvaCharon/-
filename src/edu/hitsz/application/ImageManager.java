...
public class ImageManager {
    ...
    public static BufferedImage BLOOD_RETURN_PROP;
    ...
    static {
        try {
            ...
            BLOOD_RETURN_PROP = ImageIO.read(new FileInputStream("src/images/prop_blood.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(BloodReturnProp.class.getName(),BLOOD_RETURN_PROP);
